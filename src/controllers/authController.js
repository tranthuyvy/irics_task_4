...
const registerUser = async (req, res) => {
    try {
        ...
        const newUser = {
            ...
            background_img:
                'https://test3.stechvn.org/api/file/3504639c8-8a24-11ee-9529-0242c0a83003.Grey_and_Brown_Modern_Beauty_Salon_Banner_20231024_124517_0000.svg',
...
const refreshToken = (req, res) => {
    try {
        ...
        return res
            ...
            .json({ error_code: 'Internal Server Error', success: false });
    }
};
    ...
    try {
        ...
        if (!csrfTokenHeader || csrfTokenHeader !== req.cookies.csrfToken) {
            return res
                ...
                .json({ message: 'CSRF Token mismatch - Unauthorized', success: false });
        }
